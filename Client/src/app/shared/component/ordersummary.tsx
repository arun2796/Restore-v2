...
import { Currency } from "../../../features/lib/unit";
import { Link, useLocation } from "react-router";
import { useBasket } from "../../../features/lib/hooks/useBasket";
      ...
      <Paper sx={{ mb: 2, p: 3, width: "100%", borderRadius: 3 }}>
        ...
        <Box mt={2}>
          ...
          <Box display="flex" justifyContent="space-between" mb={1}>
            ...
            <Typography>{Currency(deliveryFee)}</Typography>
          </Box>
          <Divider sx={{ my: 2 }} />
          <Box display="flex" justifyContent="space-between" mb={1}>
            <Typography color="textSecondary">Total</Typography>
            <Typography>{Currency(subtotal + deliveryFee)}</Typography>
          </Box>
        </Box>
